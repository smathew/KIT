...
ActiveRecord::Schema.define(:version => 20101101135754) do
  ...
  create_table "loanapps", :force => true do |t|
    ...
    t.string   "applicant_previous_employer1"
    ...
    t.string   "applicant_previous_employer2"
    ...
    t.string   "coapplicant_previous_employer1"
    ...
    t.string   "coapplicant_previous_employer2"
